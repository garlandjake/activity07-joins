...
**Response**: La Quinta has some locations not in the US while Dennys has all of their locations in the US.
...
**Response**: We could filter or join the locations to only be in the US.
...
**Response**: There is no dennys outside the US.
...
```{r anti}
dennys %>%
  anti_join(dennys,states,by="state",copy = FALSE,na_matches="na")
```
